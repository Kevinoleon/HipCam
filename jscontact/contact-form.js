...
(function($) {
    ...
    $("#contactForm").validator().on("submit", function(event) {
        ...
        if (event.isDefaultPrevented()) {
            formError();
            submitContactFormActionMSG(false, "Please, complete the form!");
        } else {
            var fname = $("#fname").val();
            var email = $("#email").val();
            var phone = $("#phone").val();
    ...
    function contactFormSuccess() {
        submitContactFormActionMSG(true, "Mail has been sent!");
        document.getElementById("msgExito").innerHTML = "<p style='text-align:center;'><img src='https://www.hipcam.com/25.gif'></p><p style='text-align:center;'>Redirecting in 5 seconds!</p>";
        setTimeout("location.href='https://www.hipcam.com'", 25000);
        // window.location = "https://www.hipcam.com";
    ...
    //setTimeout("contactFormSuccess()", 5000);
